...
"csv column"
"memory.total,memory.used,memory.free,pstate,temperature.gpu,name," \
"utilization.gpu,utilization.memory,index,power.draw"
...
count_gpu_utilization_ratio(df,gpu_num=2,ratio=80)
